  ...
  return (
    <div className="p-4">
     <h1 className="mt-4 text-4xl md:text-7xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50">
        ...
        <h1 className="mt-2 text-sm  font-bold text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50">
         NOTE : Hover on the cards to see my interests.
        </h1>

      <div className="py-20 flex flex-col lg:flex-row items-center justify-center bg-black w-full gap-4 mx-auto px-8">
       
      <Card title="React JS developer" icon={<IconReact />}>
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card title="Frontend Developer" icon={<IconReact />}>
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card title="Web Developer" icon={<IconReact />}>
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card title="Threejs intern" icon={<IconsReact />}>
          <CanvasRevealEffect
            animationSpeed={5.1}
...
export function IconReact({ className, ...rest }: any) {
    return (
      <svg
        viewBox="0 0 24 24"
        fill="currentColor"
 ...
 export function IconsReact(props: React.SVGProps<SVGSVGElement>) {
    return (
      <svg
        viewBox="0 0 512 512"
        fill="currentColor"
